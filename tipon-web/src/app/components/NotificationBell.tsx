...
const ICONS: Record<NotificationType, typeof Info> = {
  ...
  admin_event_created: CalendarClock,
  unverified_organizer_reminder: Users,
  admin_event_cancellation_summary: XCircle,
  event_updated: Info,
...
const ICON_COLOR: Record<NotificationType, string> = {
  ...
  admin_event_created: "text-sky-400",
  unverified_organizer_reminder: "text-amber-400",
  admin_event_cancellation_summary: "text-red-400",
